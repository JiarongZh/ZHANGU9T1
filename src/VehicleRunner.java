public class VehicleRunner
{
    public static void main(String[] args)
    {
        ...
        Bicycle myBike = new Bicycle("LifeLine",2,18);
        ...
        Tractor myTractor = new Tractor("Rundy",4,10);
        System.out.println(myTractor.getName());
        System.out.println(myTractor.getWheels());
        System.out.println(myTractor.getHeight());
        myTractor.accelerate();
